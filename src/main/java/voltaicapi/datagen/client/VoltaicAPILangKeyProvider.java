...
import voltaicapi.datagen.utils.client.BaseLangKeyProvider;
import voltaicapi.registers.*;
import net.minecraft.data.PackOutput;
import net.minecraft.world.level.Level;

public class VoltaicAPILangKeyProvider extends BaseLangKeyProvider {

    public VoltaicAPILangKeyProvider(PackOutput output, Locale local) {
        super(output, local, VoltaicAPI.ID);
    }
    ...
    protected void addTranslations() {
        ...
        switch (locale) {
            ...
            default:
                ...
                addCreativeTab("main", "Voltaic API");

                addItem(VoltaicAPIItems.GUIDEBOOK, "MEC 1st Edition");
                addItem(VoltaicAPIItems.ITEM_WRENCH, "Wrench");
                ...
                addGas(VoltaicAPIGases.EMPTY, "Empty");
                ...
                addSubtitle(VoltaicAPISounds.SOUND_BATTERY_SWAP, "Battery is swapped");
                addSubtitle(VoltaicAPISounds.SOUND_PRESSURERELEASE, "Gas hisses");
                ...
                addGuidebook("title", "Minecraft Electric Code 1st Edition");
