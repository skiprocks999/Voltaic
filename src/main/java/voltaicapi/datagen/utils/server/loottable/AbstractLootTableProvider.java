package voltaicapi.datagen.utils.server.loottable;
        ...
        LootPool.Builder builder = LootPool.lootPool()
                ...
                .add(
                        ...
                        LootItem.lootTableItem(block)
                                ...
                                .apply(function)
                                //
                                .apply(SetContainerContents.setContents(ContainerComponentManipulators.CONTAINER).withEntry(DynamicLoot.dynamicEntry(VoltaicAPI.vanillarl("contents"))))
                        //
                );
