...
public class AdvancementBuilder implements IAdvancementBuilderExtension {
    ...
    public static enum AdvancementBackgrounds {
        ...
        NONE(null),
        // Vanilla
        ADVENTURE(VoltaicAPI.vanillarl("textures/gui/advancements/backgrounds/adventure.png")), //
        END(VoltaicAPI.vanillarl("textures/gui/advancements/backgrounds/end.png")), //
        HUSBANDRY(VoltaicAPI.vanillarl("textures/gui/advancements/backgrounds/husbandry.png")), //
        NETHER(VoltaicAPI.vanillarl("textures/gui/advancements/backgrounds/nether.png")), //
        STONE(VoltaicAPI.vanillarl("textures/gui/advancements/backgrounds/stone.png")); //
