...
public class RadiationSystem {
	...
	public static void tickServer(LevelTickEvent.Pre event) {
		...
		IRadiationManager manager = level.getData(VoltaicAPIAttachmentTypes.RADIATION_MANAGER);
	...
	public static void entityTick(EntityTickEvent.Post event) {
		...
		IRadiationRecipient capability = event.getEntity().getCapability(VoltaicAPICapabilities.CAPABILITY_RADIATIONRECIPIENT);
		if(capability == null) {
			return;
		}
	...
	public static void addRadiationSource(Level world, SimpleRadiationSource source) {
		...
		IRadiationManager manager = world.getData(VoltaicAPIAttachmentTypes.RADIATION_MANAGER);
