...
public class RestrictedFluidHandlerItemStack implements IFluidHandlerItem {
    ...
    public FluidStack getFluid() {
        return container.getOrDefault(VoltaicAPIDataComponentTypes.FLUID_STACK, FluidStackComponent.EMPTY).fluid;
    }

    public void setFluid(FluidStack fluid) {
        container.set(VoltaicAPIDataComponentTypes.FLUID_STACK, new FluidStackComponent(fluid));
    }

    public void setContainerToEmpty() {
        container.remove(VoltaicAPIDataComponentTypes.FLUID_STACK);
    }
