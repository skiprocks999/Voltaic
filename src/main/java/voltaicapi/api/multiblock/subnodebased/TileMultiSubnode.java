package voltaicapi.api.multiblock.subnodebased;

import org.jetbrains.annotations.Nullable;

import voltaicapi.api.electricity.ICapabilityElectrodynamic;
import voltaicapi.api.gas.IGasHandler;
import voltaicapi.api.multiblock.subnodebased.parent.IMultiblockParentTile;
...
import voltaicapi.prefab.tile.components.type.ComponentPacketHandler;
import voltaicapi.prefab.utilities.BlockEntityUtils;
import voltaicapi.registers.VoltaicAPITiles;
...
public class TileMultiSubnode extends GenericTile {
	...
	public TileMultiSubnode(BlockPos worldPosition, BlockState blockState) {
		super(VoltaicAPITiles.TILE_MULTI.get(), worldPosition, blockState);
