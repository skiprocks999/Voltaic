...
public class GasHandlerItemStack implements IGasHandlerItem {
    ...
    public void setGas(GasStack gas) {
        ...
        container.set(VoltaicAPIDataComponentTypes.GAS_STACK, gas);
    }

    @Override
    public GasStack getGasInTank(int tank) {

        return container.getOrDefault(VoltaicAPIDataComponentTypes.GAS_STACK, GasStack.EMPTY);
    }
    ...
    public void setContainerToEmpty() {
        container.remove(VoltaicAPIDataComponentTypes.GAS_STACK);
    }
