...
import voltaicapi.prefab.item.TemperateItemProperties;
...
public interface IItemTemperate {
	...
	public static void setTemperature(ItemStack stack, double amount) {
		stack.set(VoltaicAPIDataComponentTypes.HEAT_STORED, amount);
	}

	public static double getTemperature(ItemStack stack) {

		return stack.getOrDefault(VoltaicAPIDataComponentTypes.HEAT_STORED, 0.0);
	}
