package voltaicapi.common.tags;
...
public class ModularElectricityTags {
	...
	public static class Items {
		...
		private static TagKey<Item> forgeTag(String name) {
			return ItemTags.create(VoltaicAPI.commonrl(name));
		}
	}
	...
	public static class Blocks {
		...
		private static TagKey<Block> forgeTag(String name) {
			return BlockTags.create(VoltaicAPI.commonrl(name));
		}
	...
	public static class Fluids {
		...
		private static TagKey<Fluid> forgeTag(String name) {
			return FluidTags.create(VoltaicAPI.commonrl(name));
		}
	...
	public static class Gases {
		...
		private static TagKey<Gas> forgeTag(String name) {
			return create(VoltaicAPI.commonrl(name));
		}

		public static TagKey<Gas> create(ResourceLocation loc) {
			return TagKey.create(VoltaicAPIGases.GAS_REGISTRY_KEY, loc);
		}
	}
	...
	public static class Enchantments {
		...
		private static TagKey<Enchantment> forgeTag(String name) {
			return TagKey.create(Registries.ENCHANTMENT, VoltaicAPI.commonrl(name));
		}
	}
