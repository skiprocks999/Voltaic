package voltaicapi.common.recipe.categories.fluiditem2gas;
...
public class FluidItem2GasRecipeSerializer<T extends FluidItem2GasRecipe> extends ModularElectricityRecipeSerializer<T> {
