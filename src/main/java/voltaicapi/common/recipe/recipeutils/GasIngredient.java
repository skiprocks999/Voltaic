...
public class GasIngredient implements Predicate<GasStack>, ICustomIngredient {
    ...
    instance.group(
            ...
            //
            VoltaicAPIGases.GAS_REGISTRY.byNameCodec().fieldOf("gas").forGetter(instance0 -> instance0.gas),
            //
    ...
    instance.group(
            ...
            //
            TagKey.codec(VoltaicAPIGases.GAS_REGISTRY_KEY).fieldOf("tag").forGetter(instance0 -> instance0.tag),
            //
            Codec.INT.fieldOf("amount").forGetter(instance0 -> instance0.amount),
            //
            Codec.INT.fieldOf("temp").forGetter(instance0 -> instance0.temperature),
    ...
    public IngredientType<?> getType() {
        return VoltaicAPIIngredients.GAS_INGREDIENT_TYPE.get();
    }
    ...
    public List<GasStack> getMatchingGases() {
        ...
        if (gasStacks == null) {
            ...
            if (tag != null) {
                VoltaicAPIGases.GAS_REGISTRY.getTag(tag).get().forEach(h -> {
