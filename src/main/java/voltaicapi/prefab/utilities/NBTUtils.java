...
public class NBTUtils {
	...
	public static List<Direction> readDirectionList(ItemStack item) {
		return item.getOrDefault(VoltaicAPIDataComponentTypes.DIRECTIONS, Collections.emptyList());
	}

	public static void writeDirectionList(List<Direction> dirs, ItemStack item) {
		item.set(VoltaicAPIDataComponentTypes.DIRECTIONS, dirs);
	}

	public static void clearDirectionList(ItemStack item) {
		item.remove(VoltaicAPIDataComponentTypes.DIRECTIONS);
	}
