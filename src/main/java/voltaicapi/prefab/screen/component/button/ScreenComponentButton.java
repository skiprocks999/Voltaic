package voltaicapi.prefab.screen.component.button;
...
public class ScreenComponentButton<T extends ScreenComponentButton<?>> extends ScreenComponentGeneric {
    ...
    public static final WidgetSprites VANILLA_BUTTON_SPRITES = new WidgetSprites(VoltaicAPI.vanillarl("widget/button"), VoltaicAPI.vanillarl("widget/button_disabled"), VoltaicAPI.vanillarl("widget/button_highlighted"));
