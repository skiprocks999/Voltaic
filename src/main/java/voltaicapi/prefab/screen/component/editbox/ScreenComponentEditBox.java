package voltaicapi.prefab.screen.component.editbox;
...
public class ScreenComponentEditBox extends ScreenComponentGeneric {
	...
	public static final ResourceLocation TEXTURE = VoltaicAPI.rl("textures/screen/component/textinputbar.png");
