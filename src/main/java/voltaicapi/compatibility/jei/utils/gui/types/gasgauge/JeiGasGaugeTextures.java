package voltaicapi.compatibility.jei.utils.gui.types.gasgauge;
...
public enum JeiGasGaugeTextures implements IGasGaugeTexture {
	...
	BACKGROUND_DEFAULT(14, 49, 0, 0, 41, 49, VoltaicAPI.rl("textures/screen/jei/gas_gauge_default.png")),
	LEVEL_DEFAULT(14, 49, 14, 0, 41, 49, VoltaicAPI.rl("textures/screen/jei/gas_gauge_default.png"), -1, -1);
