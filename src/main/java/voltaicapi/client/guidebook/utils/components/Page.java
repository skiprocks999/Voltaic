package voltaicapi.client.guidebook.utils.components;
...
public class Page {
	...
	public static class ChapterPage extends Page {
		...
		public void renderAdditionalText(GuiGraphics graphics, int refX, int refY, int xPageShift, Font font, int textWidth, int textStartX) {
			...
			Component chapTitle = ModularElectricityTextUtils.guidebook("chapters").withStyle(ChatFormatting.UNDERLINE);
			xShift = (textWidth - font.width(chapTitle)) / 2;
	...
	public static class ModulePage extends Page {
		...
		@Override
		public void renderAdditionalText(GuiGraphics graphics, int refX, int refY, int xPageShift, Font font, int textWidth, int textStartX) {
			Component modTitle = ModularElectricityTextUtils.guidebook("availablemodules").withStyle(ChatFormatting.BOLD);
